...
CREATE TABLE `defenses`  (
  ...
  `review_comment` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '【修改】答辩评语（≥10字，存档用）',
...
CREATE TABLE `task_books`  (
  ...
  `requirements` json NULL COMMENT '【新增】基本要求列表（JSON数组格式）：\r\n        [{\"id\": 1, \"text\": \"完成系统需求分析\"}, {\"id\": 2, \"text\": \"设计完整的数据库结构\"}]',
  `tech_params` json NULL COMMENT '【新增】技术参数表格（JSON数组格式）：\r\n        [{\"name\": \"前端框架\", \"value\": \"Vue 3 + Element Plus\", \"note\": \"响应式设计\"}, {\"name\": \"后端框架\", \"value\": \"Spring Boot 2.7+\", \"note\": \"RESTful API\"}]',
  `references` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '【新增】参考资料（每行一条）',
...
CREATE TABLE `topics`  (
  ...
  `requirements` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '【新增】技术要求详情（每行一个要求点）',
  `references` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '【新增】参考文献（每行一条，格式：[序号] 作者. 标题[J]. 期刊, 年份）',
